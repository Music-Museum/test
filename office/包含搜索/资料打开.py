...
def search_csv():
    ...
    try:
        csv_path = r"/Users/uu/Desktop/11.csv"
        # 尝试不同编码方式（按优先级尝试）
...
copy_btn = tk.Button(search_frame, text="复制", command=copy_to_clipboard, font=my_font,
                    bg="#b4d8f2", fg="#696969", relief="flat")
copy_btn.pack(side=tk.LEFT, pady=2)
...
# 版本信息标签
version_label = tk.Label(main_frame, text="V1.3/9022564", foreground="#777777", cursor="hand2", font=my_font,
                         bg="#F0EAD6")
